...
class IFCPP_EXPORT IfcTubeBundleTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcTubeBundleType : public IfcEnergyConversionDeviceType
{ 
public:
	IfcTubeBundleType();
	IfcTubeBundleType( int id );
	~IfcTubeBundleType();
	...
	virtual const char* className() const { return "IfcTubeBundleType"; }
	...
	// IfcTubeBundleType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcTubeBundleTypeEnum>					m_PredefinedType;
};
