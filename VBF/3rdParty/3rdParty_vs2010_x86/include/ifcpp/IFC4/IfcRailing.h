...
//ENTITY
class IFCPP_EXPORT IfcRailing : public IfcBuildingElement
{ 
public:
	IfcRailing();
	IfcRailing( int id );
	...
	virtual const char* className() const { return "IfcRailing"; }
	...
	// IfcRailing -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcRailingTypeEnum>								m_PredefinedType;			//optional
};
