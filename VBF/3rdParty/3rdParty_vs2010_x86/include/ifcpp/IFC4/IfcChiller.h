...
class IFCPP_EXPORT IfcChillerTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcChiller : public IfcEnergyConversionDevice
{ 
public:
	IfcChiller();
	IfcChiller( int id );
	...
	virtual const char* className() const { return "IfcChiller"; }
	...
	// IfcChiller -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcChillerTypeEnum>								m_PredefinedType;			//optional
};
