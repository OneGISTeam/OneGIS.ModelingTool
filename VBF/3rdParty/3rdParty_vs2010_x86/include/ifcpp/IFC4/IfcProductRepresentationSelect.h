...
class IFCPP_EXPORT IfcProductRepresentationSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcProductRepresentationSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
