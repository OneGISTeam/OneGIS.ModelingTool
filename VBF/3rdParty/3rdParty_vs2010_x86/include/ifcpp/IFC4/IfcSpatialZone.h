...
//ENTITY
class IFCPP_EXPORT IfcSpatialZone : public IfcSpatialElement
{ 
public:
	IfcSpatialZone();
	...
	virtual const char* className() const { return "IfcSpatialZone"; }
	...
	// IfcSpatialZone -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcSpatialZoneTypeEnum>							m_PredefinedType;			//optional
};
