...
class IFCPP_EXPORT IfcSanitaryTerminalTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcSanitaryTerminal : public IfcFlowTerminal
{ 
public:
	IfcSanitaryTerminal();
	IfcSanitaryTerminal( int id );
	~IfcSanitaryTerminal();
	...
	virtual const char* className() const { return "IfcSanitaryTerminal"; }
	...
	// IfcSanitaryTerminal -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcSanitaryTerminalTypeEnum>						m_PredefinedType;			//optional
};
