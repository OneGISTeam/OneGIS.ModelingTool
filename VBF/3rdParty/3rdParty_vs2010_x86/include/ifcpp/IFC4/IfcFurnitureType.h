...
class IFCPP_EXPORT IfcAssemblyPlaceEnum;
class IFCPP_EXPORT IfcFurnitureTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcFurnitureType : public IfcFurnishingElementType
{ 
public:
	IfcFurnitureType();
	IfcFurnitureType( int id );
	~IfcFurnitureType();
	...
	virtual const char* className() const { return "IfcFurnitureType"; }
	...
	// IfcFurnitureType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcAssemblyPlaceEnum>					m_AssemblyPlace;
	shared_ptr<IfcFurnitureTypeEnum>					m_PredefinedType;			//optional
};
