...
class IFCPP_EXPORT IfcStackTerminalTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcStackTerminalType : public IfcFlowTerminalType
{ 
public:
	...
	virtual const char* className() const { return "IfcStackTerminalType"; }
	...
	// IfcStackTerminalType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcStackTerminalTypeEnum>				m_PredefinedType;
};
