...
//ENTITY
class IFCPP_EXPORT IfcVibrationIsolatorType : public IfcElementComponentType
{ 
public:
	...
	virtual const char* className() const { return "IfcVibrationIsolatorType"; }
	...
	// IfcVibrationIsolatorType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcVibrationIsolatorTypeEnum>			m_PredefinedType;
};
