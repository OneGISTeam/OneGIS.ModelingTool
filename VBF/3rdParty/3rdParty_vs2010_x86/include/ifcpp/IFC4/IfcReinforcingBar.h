...
//ENTITY
class IFCPP_EXPORT IfcReinforcingBar : public IfcReinforcingElement
{ 
public:
	IfcReinforcingBar();
	...
	virtual const char* className() const { return "IfcReinforcingBar"; }
	...
	shared_ptr<IfcReinforcingBarTypeEnum>						m_PredefinedType;			//optional
