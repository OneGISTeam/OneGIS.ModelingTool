...
//ENTITY
class IFCPP_EXPORT IfcDuctSegmentType : public IfcFlowSegmentType
{ 
public:
	IfcDuctSegmentType();
	...
	virtual const char* className() const { return "IfcDuctSegmentType"; }
	...
	// IfcDuctSegmentType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcDuctSegmentTypeEnum>					m_PredefinedType;
};
