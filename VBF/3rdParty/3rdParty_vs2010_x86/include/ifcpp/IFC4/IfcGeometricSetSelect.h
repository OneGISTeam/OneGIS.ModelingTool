...
class IFCPP_EXPORT IfcGeometricSetSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcGeometricSetSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
