...
class IFCPP_EXPORT IfcRotationalStiffnessSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcRotationalStiffnessSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
