...
//ENTITY
class IFCPP_EXPORT IfcShadingDeviceType : public IfcBuildingElementType
{ 
public:
	...
	virtual const char* className() const { return "IfcShadingDeviceType"; }
	...
	// IfcShadingDeviceType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcShadingDeviceTypeEnum>				m_PredefinedType;
};
