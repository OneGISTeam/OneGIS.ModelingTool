...
class IFCPP_EXPORT IfcPipeFittingTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcPipeFittingType : public IfcFlowFittingType
{ 
public:
	IfcPipeFittingType();
	IfcPipeFittingType( int id );
	~IfcPipeFittingType();
	...
	virtual const char* className() const { return "IfcPipeFittingType"; }
	...
	// IfcPipeFittingType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcPipeFittingTypeEnum>					m_PredefinedType;
};
