...
class IFCPP_EXPORT IfcUnitaryControlElementTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcUnitaryControlElementType : public IfcDistributionControlElementType
{ 
public:
	...
	virtual const char* className() const { return "IfcUnitaryControlElementType"; }
	...
	// IfcUnitaryControlElementType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcUnitaryControlElementTypeEnum>		m_PredefinedType;
};
