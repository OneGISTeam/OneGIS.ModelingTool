...
class IFCPP_EXPORT IfcFilterTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcFilterType : public IfcFlowTreatmentDeviceType
{ 
public:
	IfcFilterType();
	IfcFilterType( int id );
	~IfcFilterType();
	...
	virtual const char* className() const { return "IfcFilterType"; }
	...
	// IfcFilterType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcFilterTypeEnum>						m_PredefinedType;
};
