...
//ENTITY
class IFCPP_EXPORT IfcDiscreteAccessoryType : public IfcElementComponentType
{ 
public:
	IfcDiscreteAccessoryType();
	IfcDiscreteAccessoryType( int id );
	~IfcDiscreteAccessoryType();
	...
	virtual const char* className() const { return "IfcDiscreteAccessoryType"; }
	...
	// IfcDiscreteAccessoryType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcDiscreteAccessoryTypeEnum>			m_PredefinedType;
};
