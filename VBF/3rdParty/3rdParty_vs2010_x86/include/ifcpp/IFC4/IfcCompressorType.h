...
//ENTITY
class IFCPP_EXPORT IfcCompressorType : public IfcFlowMovingDeviceType
{ 
public:
	IfcCompressorType();
	...
	virtual const char* className() const { return "IfcCompressorType"; }
	...
	// IfcCompressorType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcCompressorTypeEnum>					m_PredefinedType;
};
