...
class IFCPP_EXPORT IfcCoolingTowerTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcCoolingTowerType : public IfcEnergyConversionDeviceType
{ 
public:
	IfcCoolingTowerType();
	IfcCoolingTowerType( int id );
	~IfcCoolingTowerType();
	...
	virtual const char* className() const { return "IfcCoolingTowerType"; }
	...
	// IfcCoolingTowerType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcCoolingTowerTypeEnum>					m_PredefinedType;
};
