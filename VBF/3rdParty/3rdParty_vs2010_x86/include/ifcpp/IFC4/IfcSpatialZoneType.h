...
class IFCPP_EXPORT IfcSpatialZoneTypeEnum;
class IFCPP_EXPORT IfcLabel;
//ENTITY
class IFCPP_EXPORT IfcSpatialZoneType : public IfcSpatialElementType
{ 
public:
	IfcSpatialZoneType();
	...
	virtual const char* className() const { return "IfcSpatialZoneType"; }
	...
	// IfcSpatialZoneType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcSpatialZoneTypeEnum>					m_PredefinedType;
