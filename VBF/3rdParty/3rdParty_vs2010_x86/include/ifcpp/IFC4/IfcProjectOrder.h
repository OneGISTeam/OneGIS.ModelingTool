...
class IFCPP_EXPORT IfcProjectOrderTypeEnum;
class IFCPP_EXPORT IfcLabel;
class IFCPP_EXPORT IfcText;
//ENTITY
class IFCPP_EXPORT IfcProjectOrder : public IfcControl
{ 
public:
	IfcProjectOrder();
	...
	virtual const char* className() const { return "IfcProjectOrder"; }
	...
	// IfcProjectOrder -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcProjectOrderTypeEnum>					m_PredefinedType;			//optional
