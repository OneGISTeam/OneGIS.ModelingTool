...
class IFCPP_EXPORT IfcCsgSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcCsgSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
