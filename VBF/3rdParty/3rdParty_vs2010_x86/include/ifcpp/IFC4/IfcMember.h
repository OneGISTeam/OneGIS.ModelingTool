...
class IFCPP_EXPORT IfcMemberTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcMember : public IfcBuildingElement
{ 
public:
	IfcMember();
	IfcMember( int id );
	...
	virtual const char* className() const { return "IfcMember"; }
	...
	// IfcMember -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcMemberTypeEnum>								m_PredefinedType;			//optional
};
