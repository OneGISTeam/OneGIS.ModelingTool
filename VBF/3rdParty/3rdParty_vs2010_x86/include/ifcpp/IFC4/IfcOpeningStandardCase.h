...
//ENTITY
class IFCPP_EXPORT IfcOpeningStandardCase : public IfcOpeningElement
{ 
public:
	...
	virtual const char* className() const { return "IfcOpeningStandardCase"; }
	...
	// IfcOpeningElement -----------------------------------------------------------
	// attributes:
	//  shared_ptr<IfcOpeningElementTypeEnum>						m_PredefinedType;			//optional
	// inverse attributes:
