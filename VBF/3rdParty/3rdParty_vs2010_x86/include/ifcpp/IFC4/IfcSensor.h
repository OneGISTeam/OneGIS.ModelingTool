...
class IFCPP_EXPORT IfcSensorTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcSensor : public IfcDistributionControlElement
{ 
public:
	IfcSensor();
	IfcSensor( int id );
	...
	virtual const char* className() const { return "IfcSensor"; }
	...
	// IfcSensor -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcSensorTypeEnum>								m_PredefinedType;			//optional
};
