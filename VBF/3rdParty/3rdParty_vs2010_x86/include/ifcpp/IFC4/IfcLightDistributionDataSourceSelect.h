...
public:
	...
	static shared_ptr<IfcLightDistributionDataSourceSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
