...
class IFCPP_EXPORT IfcCoilTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcCoil : public IfcEnergyConversionDevice
{ 
public:
	IfcCoil();
	IfcCoil( int id );
	...
	virtual const char* className() const { return "IfcCoil"; }
	...
	// IfcCoil -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcCoilTypeEnum>									m_PredefinedType;			//optional
};
