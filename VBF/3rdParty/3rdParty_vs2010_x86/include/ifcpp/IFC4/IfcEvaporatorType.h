...
class IFCPP_EXPORT IfcEvaporatorTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcEvaporatorType : public IfcEnergyConversionDeviceType
{ 
public:
	IfcEvaporatorType();
	IfcEvaporatorType( int id );
	~IfcEvaporatorType();
	...
	virtual const char* className() const { return "IfcEvaporatorType"; }
	...
	// IfcEvaporatorType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcEvaporatorTypeEnum>					m_PredefinedType;
};
