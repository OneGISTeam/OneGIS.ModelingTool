...
class IFCPP_EXPORT IfcOutletTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcOutletType : public IfcFlowTerminalType
{ 
public:
	IfcOutletType();
	...
	virtual const char* className() const { return "IfcOutletType"; }
	...
	// IfcOutletType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcOutletTypeEnum>						m_PredefinedType;
};
