...
class IFCPP_EXPORT IfcFlowInstrumentTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcFlowInstrumentType : public IfcDistributionControlElementType
{ 
public:
	...
	virtual const char* className() const { return "IfcFlowInstrumentType"; }
