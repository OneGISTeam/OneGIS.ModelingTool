...
class IFCPP_EXPORT IfcCondenserTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcCondenserType : public IfcEnergyConversionDeviceType
{ 
public:
	IfcCondenserType();
	IfcCondenserType( int id );
	~IfcCondenserType();
	...
	virtual const char* className() const { return "IfcCondenserType"; }
	...
	// IfcCondenserType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcCondenserTypeEnum>					m_PredefinedType;
};
