...
class IFCPP_EXPORT IfcBooleanOperand : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcBooleanOperand> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
