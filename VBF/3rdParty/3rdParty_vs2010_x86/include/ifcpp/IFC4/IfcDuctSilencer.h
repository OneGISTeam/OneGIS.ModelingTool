...
//ENTITY
class IFCPP_EXPORT IfcDuctSilencer : public IfcFlowTreatmentDevice
{ 
public:
	IfcDuctSilencer();
	...
	virtual const char* className() const { return "IfcDuctSilencer"; }
	...
	// IfcDuctSilencer -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcDuctSilencerTypeEnum>							m_PredefinedType;			//optional
};
