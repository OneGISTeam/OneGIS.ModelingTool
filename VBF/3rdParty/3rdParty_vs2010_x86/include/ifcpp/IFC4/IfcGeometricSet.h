...
class IFCPP_EXPORT IfcGeometricSetSelect;
//ENTITY
class IFCPP_EXPORT IfcGeometricSet : public IfcGeometricRepresentationItem
{ 
public:
	IfcGeometricSet();
	...
	virtual const char* className() const { return "IfcGeometricSet"; }
