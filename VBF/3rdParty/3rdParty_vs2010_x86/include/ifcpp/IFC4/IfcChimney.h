...
class IFCPP_EXPORT IfcChimneyTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcChimney : public IfcBuildingElement
{ 
public:
	IfcChimney();
	IfcChimney( int id );
	...
	virtual const char* className() const { return "IfcChimney"; }
	...
	// IfcChimney -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcChimneyTypeEnum>								m_PredefinedType;			//optional
};
