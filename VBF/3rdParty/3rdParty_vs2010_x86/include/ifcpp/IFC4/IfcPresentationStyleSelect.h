...
class IFCPP_EXPORT IfcPresentationStyleSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcPresentationStyleSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
