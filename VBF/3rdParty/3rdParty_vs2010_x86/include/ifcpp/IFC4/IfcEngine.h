...
//ENTITY
class IFCPP_EXPORT IfcEngine : public IfcEnergyConversionDevice
{ 
public:
	IfcEngine();
	IfcEngine( int id );
	...
	virtual const char* className() const { return "IfcEngine"; }
	...
	// IfcEngine -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcEngineTypeEnum>								m_PredefinedType;			//optional
};
