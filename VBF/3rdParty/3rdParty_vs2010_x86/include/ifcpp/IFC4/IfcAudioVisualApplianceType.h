...
//ENTITY
class IFCPP_EXPORT IfcAudioVisualApplianceType : public IfcFlowTerminalType
{ 
public:
	...
	virtual const char* className() const { return "IfcAudioVisualApplianceType"; }
	...
	// IfcAudioVisualApplianceType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcAudioVisualApplianceTypeEnum>			m_PredefinedType;
};
