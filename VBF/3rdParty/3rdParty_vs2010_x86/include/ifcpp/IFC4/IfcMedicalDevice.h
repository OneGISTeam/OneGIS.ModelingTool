...
//ENTITY
class IFCPP_EXPORT IfcMedicalDevice : public IfcFlowTerminal
{ 
public:
	IfcMedicalDevice();
	...
	virtual const char* className() const { return "IfcMedicalDevice"; }
	...
	// IfcMedicalDevice -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcMedicalDeviceTypeEnum>						m_PredefinedType;			//optional
};
