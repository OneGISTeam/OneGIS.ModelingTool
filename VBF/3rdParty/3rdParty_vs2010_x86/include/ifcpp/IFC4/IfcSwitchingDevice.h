...
//ENTITY
class IFCPP_EXPORT IfcSwitchingDevice : public IfcFlowController
{ 
public:
	IfcSwitchingDevice();
	...
	virtual const char* className() const { return "IfcSwitchingDevice"; }
	...
	// IfcSwitchingDevice -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcSwitchingDeviceTypeEnum>						m_PredefinedType;			//optional
};
