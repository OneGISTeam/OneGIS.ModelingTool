...
class IFCPP_EXPORT IfcPumpTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcPumpType : public IfcFlowMovingDeviceType
{ 
public:
	IfcPumpType();
	IfcPumpType( int id );
	...
	virtual const char* className() const { return "IfcPumpType"; }
	...
	// IfcPumpType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcPumpTypeEnum>							m_PredefinedType;
};
