...
class IFCPP_EXPORT IfcStairTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcStairType : public IfcBuildingElementType
{ 
public:
	IfcStairType();
	IfcStairType( int id );
	...
	virtual const char* className() const { return "IfcStairType"; }
	...
	// IfcStairType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcStairTypeEnum>						m_PredefinedType;
};
