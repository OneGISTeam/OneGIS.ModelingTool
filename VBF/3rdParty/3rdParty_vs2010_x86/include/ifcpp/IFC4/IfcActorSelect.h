...
class IFCPP_EXPORT IfcActorSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcActorSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
