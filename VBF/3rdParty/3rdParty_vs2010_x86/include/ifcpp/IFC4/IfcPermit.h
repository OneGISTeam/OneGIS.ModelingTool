...
class IFCPP_EXPORT IfcPermitTypeEnum;
class IFCPP_EXPORT IfcLabel;
class IFCPP_EXPORT IfcText;
//ENTITY
class IFCPP_EXPORT IfcPermit : public IfcControl
{ 
public:
	IfcPermit();
	IfcPermit( int id );
	...
	virtual const char* className() const { return "IfcPermit"; }
	...
	// IfcPermit -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcPermitTypeEnum>						m_PredefinedType;			//optional
