...
//ENTITY
class IFCPP_EXPORT IfcSystemFurnitureElement : public IfcFurnishingElement
{ 
public:
	IfcSystemFurnitureElement();
	IfcSystemFurnitureElement( int id );
	~IfcSystemFurnitureElement();
	...
	virtual const char* className() const { return "IfcSystemFurnitureElement"; }
	...
	// IfcSystemFurnitureElement -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcSystemFurnitureElementTypeEnum>				m_PredefinedType;			//optional
};
