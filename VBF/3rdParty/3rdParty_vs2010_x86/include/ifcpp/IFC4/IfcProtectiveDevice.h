...
class IFCPP_EXPORT IfcProtectiveDeviceTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcProtectiveDevice : public IfcFlowController
{ 
public:
	IfcProtectiveDevice();
	IfcProtectiveDevice( int id );
	~IfcProtectiveDevice();
	...
	virtual const char* className() const { return "IfcProtectiveDevice"; }
	...
	// IfcProtectiveDevice -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcProtectiveDeviceTypeEnum>						m_PredefinedType;			//optional
};
