...
//ENTITY
class IFCPP_EXPORT IfcBeamType : public IfcBuildingElementType
{ 
public:
	IfcBeamType();
	IfcBeamType( int id );
	...
	virtual const char* className() const { return "IfcBeamType"; }
	...
	// IfcBeamType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcBeamTypeEnum>							m_PredefinedType;
};
