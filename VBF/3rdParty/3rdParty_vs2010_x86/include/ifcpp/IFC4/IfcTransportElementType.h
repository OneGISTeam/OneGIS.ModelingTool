...
class IFCPP_EXPORT IfcTransportElementTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcTransportElementType : public IfcElementType
{ 
public:
	...
	virtual const char* className() const { return "IfcTransportElementType"; }
