...
class IFCPP_EXPORT IfcCooledBeamTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcCooledBeamType : public IfcEnergyConversionDeviceType
{ 
public:
	IfcCooledBeamType();
	IfcCooledBeamType( int id );
	~IfcCooledBeamType();
	...
	virtual const char* className() const { return "IfcCooledBeamType"; }
	...
	// IfcCooledBeamType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcCooledBeamTypeEnum>					m_PredefinedType;
};
