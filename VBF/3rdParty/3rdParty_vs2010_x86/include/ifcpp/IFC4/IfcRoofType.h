...
class IFCPP_EXPORT IfcRoofTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcRoofType : public IfcBuildingElementType
{ 
public:
	IfcRoofType();
	IfcRoofType( int id );
	...
	virtual const char* className() const { return "IfcRoofType"; }
	...
	// IfcRoofType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcRoofTypeEnum>							m_PredefinedType;
};
