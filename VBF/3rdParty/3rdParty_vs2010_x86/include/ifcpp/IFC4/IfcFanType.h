...
//ENTITY
class IFCPP_EXPORT IfcFanType : public IfcFlowMovingDeviceType
{ 
public:
	IfcFanType();
	IfcFanType( int id );
	...
	virtual const char* className() const { return "IfcFanType"; }
	...
	// IfcFanType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcFanTypeEnum>							m_PredefinedType;
};
