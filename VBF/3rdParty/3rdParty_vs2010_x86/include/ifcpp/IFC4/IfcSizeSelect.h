...
class IFCPP_EXPORT IfcSizeSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcSizeSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
