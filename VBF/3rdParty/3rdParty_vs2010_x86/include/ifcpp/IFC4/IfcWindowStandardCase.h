...
#include "IfcWindow.h"
//ENTITY
class IFCPP_EXPORT IfcWindowStandardCase : public IfcWindow
{ 
public:
	...
	virtual const char* className() const { return "IfcWindowStandardCase"; }
	...
	//  shared_ptr<IfcWindowTypeEnum>								m_PredefinedType;			//optional
	//  shared_ptr<IfcWindowTypePartitioningEnum>					m_PartitioningType;			//optional
