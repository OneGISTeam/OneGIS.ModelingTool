...
class IFCPP_EXPORT IfcHeatExchangerTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcHeatExchangerType : public IfcEnergyConversionDeviceType
{ 
public:
	...
	virtual const char* className() const { return "IfcHeatExchangerType"; }
	...
	// IfcHeatExchangerType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcHeatExchangerTypeEnum>				m_PredefinedType;
};
