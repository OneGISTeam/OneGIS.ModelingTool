...
class IFCPP_EXPORT IfcAudioVisualApplianceTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcAudioVisualAppliance : public IfcFlowTerminal
{ 
public:
	IfcAudioVisualAppliance();
	IfcAudioVisualAppliance( int id );
	~IfcAudioVisualAppliance();
	...
	virtual const char* className() const { return "IfcAudioVisualAppliance"; }
	...
	// IfcAudioVisualAppliance -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcAudioVisualApplianceTypeEnum>					m_PredefinedType;			//optional
};
