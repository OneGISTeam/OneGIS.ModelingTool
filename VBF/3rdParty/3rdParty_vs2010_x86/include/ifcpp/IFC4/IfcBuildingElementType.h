...
//ENTITY
class IFCPP_EXPORT IfcBuildingElementType : public IfcElementType
{ 
public:
	IfcBuildingElementType();
	IfcBuildingElementType( int id );
	~IfcBuildingElementType();
	...
	virtual const char* className() const { return "IfcBuildingElementType"; }
