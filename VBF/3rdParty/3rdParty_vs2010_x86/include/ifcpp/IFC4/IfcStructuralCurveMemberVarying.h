...
//ENTITY
class IFCPP_EXPORT IfcStructuralCurveMemberVarying : public IfcStructuralCurveMember
{ 
public:
	...
	virtual const char* className() const { return "IfcStructuralCurveMemberVarying"; }
