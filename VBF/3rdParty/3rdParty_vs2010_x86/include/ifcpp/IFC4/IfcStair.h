...
//ENTITY
class IFCPP_EXPORT IfcStair : public IfcBuildingElement
{ 
public:
	IfcStair();
	IfcStair( int id );
	...
	virtual const char* className() const { return "IfcStair"; }
	...
	// IfcStair -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcStairTypeEnum>								m_PredefinedType;			//optional
};
