...
class IFCPP_EXPORT IfcHatchLineDistanceSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcHatchLineDistanceSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
