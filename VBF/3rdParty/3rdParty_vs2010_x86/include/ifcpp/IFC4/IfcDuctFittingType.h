...
class IFCPP_EXPORT IfcDuctFittingTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcDuctFittingType : public IfcFlowFittingType
{ 
public:
	IfcDuctFittingType();
	IfcDuctFittingType( int id );
	~IfcDuctFittingType();
	...
	virtual const char* className() const { return "IfcDuctFittingType"; }
	...
	// IfcDuctFittingType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcDuctFittingTypeEnum>					m_PredefinedType;
};
