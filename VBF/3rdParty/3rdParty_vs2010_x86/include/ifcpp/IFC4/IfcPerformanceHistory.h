...
public:
	...
	virtual const char* className() const { return "IfcPerformanceHistory"; }
	...
	// IfcPerformanceHistory -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcLabel>								m_LifeCyclePhase;
	shared_ptr<IfcPerformanceHistoryTypeEnum>			m_PredefinedType;			//optional
};
