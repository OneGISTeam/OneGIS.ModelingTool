...
//ENTITY
class IFCPP_EXPORT IfcProtectiveDeviceTrippingUnit : public IfcDistributionControlElement
{ 
public:
	...
	virtual const char* className() const { return "IfcProtectiveDeviceTrippingUnit"; }
	...
	// IfcProtectiveDeviceTrippingUnit -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcProtectiveDeviceTrippingUnitTypeEnum>			m_PredefinedType;			//optional
};
