...
class IFCPP_EXPORT IfcControllerTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcControllerType : public IfcDistributionControlElementType
{ 
public:
	IfcControllerType();
	IfcControllerType( int id );
	~IfcControllerType();
	...
	virtual const char* className() const { return "IfcControllerType"; }
	...
	// IfcControllerType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcControllerTypeEnum>					m_PredefinedType;
};
