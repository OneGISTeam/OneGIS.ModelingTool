...
class IFCPP_EXPORT IfcCurveFontOrScaledCurveFontSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcCurveFontOrScaledCurveFontSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
