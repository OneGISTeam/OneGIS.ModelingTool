...
class IFCPP_EXPORT IfcElementAssemblyTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcElementAssemblyType : public IfcElementType
{ 
public:
	IfcElementAssemblyType();
	IfcElementAssemblyType( int id );
	~IfcElementAssemblyType();
	...
	virtual const char* className() const { return "IfcElementAssemblyType"; }
	...
	// IfcElementAssemblyType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcElementAssemblyTypeEnum>				m_PredefinedType;
};
