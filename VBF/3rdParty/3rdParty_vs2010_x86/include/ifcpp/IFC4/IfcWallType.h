...
class IFCPP_EXPORT IfcWallTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcWallType : public IfcBuildingElementType
{ 
public:
	IfcWallType();
	IfcWallType( int id );
	...
	virtual const char* className() const { return "IfcWallType"; }
	...
	// IfcWallType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcWallTypeEnum>							m_PredefinedType;
};
