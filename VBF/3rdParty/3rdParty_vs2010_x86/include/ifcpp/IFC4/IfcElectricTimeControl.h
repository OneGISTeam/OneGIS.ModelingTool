...
class IFCPP_EXPORT IfcElectricTimeControlTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcElectricTimeControl : public IfcFlowController
{ 
public:
	...
	virtual const char* className() const { return "IfcElectricTimeControl"; }
