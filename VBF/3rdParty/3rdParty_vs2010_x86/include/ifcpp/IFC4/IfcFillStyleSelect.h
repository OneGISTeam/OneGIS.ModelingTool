...
class IFCPP_EXPORT IfcFillStyleSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcFillStyleSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
