...
//ENTITY
class IFCPP_EXPORT IfcSanitaryTerminalType : public IfcFlowTerminalType
{ 
public:
	...
	virtual const char* className() const { return "IfcSanitaryTerminalType"; }
	...
	// IfcSanitaryTerminalType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcSanitaryTerminalTypeEnum>				m_PredefinedType;
};
