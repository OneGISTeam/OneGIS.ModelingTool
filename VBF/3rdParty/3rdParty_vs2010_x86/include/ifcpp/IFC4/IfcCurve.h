...
//ENTITY
class IFCPP_EXPORT IfcCurve : virtual public IfcGeometricSetSelect, public IfcGeometricRepresentationItem
{ 
public:
	IfcCurve();
	IfcCurve( int id );
	...
	virtual const char* className() const { return "IfcCurve"; }
