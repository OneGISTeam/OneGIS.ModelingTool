...
class IFCPP_EXPORT IfcSpaceHeaterTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcSpaceHeater : public IfcFlowTerminal
{ 
public:
	IfcSpaceHeater();
	IfcSpaceHeater( int id );
	~IfcSpaceHeater();
	...
	virtual const char* className() const { return "IfcSpaceHeater"; }
	...
	// IfcSpaceHeater -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcSpaceHeaterTypeEnum>							m_PredefinedType;			//optional
};
