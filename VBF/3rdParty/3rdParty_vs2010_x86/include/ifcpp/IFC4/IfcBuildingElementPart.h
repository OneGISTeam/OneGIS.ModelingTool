...
//ENTITY
class IFCPP_EXPORT IfcBuildingElementPart : public IfcElementComponent
{ 
public:
	IfcBuildingElementPart();
	IfcBuildingElementPart( int id );
	~IfcBuildingElementPart();
	...
	virtual const char* className() const { return "IfcBuildingElementPart"; }
	...
	// IfcBuildingElementPart -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcBuildingElementPartTypeEnum>					m_PredefinedType;			//optional
};
