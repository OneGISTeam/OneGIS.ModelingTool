...
class IFCPP_EXPORT IfcUnitaryEquipmentTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcUnitaryEquipment : public IfcEnergyConversionDevice
{ 
public:
	IfcUnitaryEquipment();
	IfcUnitaryEquipment( int id );
	~IfcUnitaryEquipment();
	...
	virtual const char* className() const { return "IfcUnitaryEquipment"; }
	...
	// IfcUnitaryEquipment -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcUnitaryEquipmentTypeEnum>						m_PredefinedType;			//optional
};
