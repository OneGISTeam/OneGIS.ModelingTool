...
class IFCPP_EXPORT IfcSurfaceFeatureTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcSurfaceFeature : public IfcFeatureElement
{ 
public:
	IfcSurfaceFeature();
	...
	virtual const char* className() const { return "IfcSurfaceFeature"; }
	...
	// IfcSurfaceFeature -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcSurfaceFeatureTypeEnum>						m_PredefinedType;			//optional
};
