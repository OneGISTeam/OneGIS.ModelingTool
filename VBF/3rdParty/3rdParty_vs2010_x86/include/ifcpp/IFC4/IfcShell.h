...
class IFCPP_EXPORT IfcShell : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcShell> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
