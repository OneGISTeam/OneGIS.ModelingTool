...
class IFCPP_EXPORT IfcAppliedValueSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcAppliedValueSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
