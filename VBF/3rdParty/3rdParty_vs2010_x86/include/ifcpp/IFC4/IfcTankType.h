...
class IFCPP_EXPORT IfcTankTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcTankType : public IfcFlowStorageDeviceType
{ 
public:
	IfcTankType();
	IfcTankType( int id );
	...
	virtual const char* className() const { return "IfcTankType"; }
	...
	// IfcTankType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcTankTypeEnum>							m_PredefinedType;
};
