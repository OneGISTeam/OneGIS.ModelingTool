...
//ENTITY
class IFCPP_EXPORT IfcFlowStorageDevice : public IfcDistributionFlowElement
{ 
public:
	IfcFlowStorageDevice();
	IfcFlowStorageDevice( int id );
	~IfcFlowStorageDevice();
	...
	virtual const char* className() const { return "IfcFlowStorageDevice"; }
