...
//ENTITY
class IFCPP_EXPORT IfcCurtainWallType : public IfcBuildingElementType
{ 
public:
	IfcCurtainWallType();
	...
	virtual const char* className() const { return "IfcCurtainWallType"; }
	...
	// IfcCurtainWallType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcCurtainWallTypeEnum>					m_PredefinedType;
};
