...
class IFCPP_EXPORT IfcDuctSilencerTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcDuctSilencerType : public IfcFlowTreatmentDeviceType
{ 
public:
	IfcDuctSilencerType();
	IfcDuctSilencerType( int id );
	~IfcDuctSilencerType();
	...
	virtual const char* className() const { return "IfcDuctSilencerType"; }
	...
	// IfcDuctSilencerType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcDuctSilencerTypeEnum>					m_PredefinedType;
};
