...
//ENTITY
class IFCPP_EXPORT IfcFilter : public IfcFlowTreatmentDevice
{ 
public:
	IfcFilter();
	IfcFilter( int id );
	...
	virtual const char* className() const { return "IfcFilter"; }
	...
	// IfcFilter -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcFilterTypeEnum>								m_PredefinedType;			//optional
};
