...
//ENTITY
class IFCPP_EXPORT IfcFlowSegmentType : public IfcDistributionFlowElementType
{ 
public:
	IfcFlowSegmentType();
	IfcFlowSegmentType( int id );
	~IfcFlowSegmentType();
	...
	virtual const char* className() const { return "IfcFlowSegmentType"; }
