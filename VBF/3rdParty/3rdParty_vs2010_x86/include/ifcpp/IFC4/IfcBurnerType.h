...
class IFCPP_EXPORT IfcBurnerTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcBurnerType : public IfcEnergyConversionDeviceType
{ 
public:
	IfcBurnerType();
	IfcBurnerType( int id );
	~IfcBurnerType();
	...
	virtual const char* className() const { return "IfcBurnerType"; }
	...
	// IfcBurnerType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcBurnerTypeEnum>						m_PredefinedType;
};
