...
//ENTITY
class IFCPP_EXPORT IfcCableCarrierSegment : public IfcFlowSegment
{ 
public:
	...
	virtual const char* className() const { return "IfcCableCarrierSegment"; }
	...
	// IfcCableCarrierSegment -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcCableCarrierSegmentTypeEnum>					m_PredefinedType;			//optional
};
