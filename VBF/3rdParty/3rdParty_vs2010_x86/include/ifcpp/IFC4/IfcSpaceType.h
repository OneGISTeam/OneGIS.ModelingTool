...
class IFCPP_EXPORT IfcSpaceTypeEnum;
class IFCPP_EXPORT IfcLabel;
//ENTITY
class IFCPP_EXPORT IfcSpaceType : public IfcSpatialStructureElementType
{ 
public:
	IfcSpaceType();
	IfcSpaceType( int id );
	...
	virtual const char* className() const { return "IfcSpaceType"; }
	...
	// IfcSpaceType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcSpaceTypeEnum>						m_PredefinedType;
