...
//ENTITY
class IFCPP_EXPORT IfcLightFixtureType : public IfcFlowTerminalType
{ 
public:
	IfcLightFixtureType();
	IfcLightFixtureType( int id );
	~IfcLightFixtureType();
	...
	virtual const char* className() const { return "IfcLightFixtureType"; }
	...
	// IfcLightFixtureType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcLightFixtureTypeEnum>					m_PredefinedType;
};
