...
//ENTITY
class IFCPP_EXPORT IfcEvaporator : public IfcEnergyConversionDevice
{ 
public:
	IfcEvaporator();
	IfcEvaporator( int id );
	~IfcEvaporator();
	...
	virtual const char* className() const { return "IfcEvaporator"; }
	...
	// IfcEvaporator -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcEvaporatorTypeEnum>							m_PredefinedType;			//optional
};
