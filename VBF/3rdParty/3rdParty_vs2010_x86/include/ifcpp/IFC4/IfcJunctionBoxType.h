...
class IFCPP_EXPORT IfcJunctionBoxTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcJunctionBoxType : public IfcFlowFittingType
{ 
public:
	IfcJunctionBoxType();
	...
	virtual const char* className() const { return "IfcJunctionBoxType"; }
	...
	// IfcJunctionBoxType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcJunctionBoxTypeEnum>					m_PredefinedType;
};
