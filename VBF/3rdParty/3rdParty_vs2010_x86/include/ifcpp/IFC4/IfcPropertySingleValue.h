...
//ENTITY
class IFCPP_EXPORT IfcPropertySingleValue : public IfcSimpleProperty
{ 
public:
	...
	virtual const char* className() const { return "IfcPropertySingleValue"; }
	...
	// IfcPropertySingleValue -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcValue>										m_NominalValue;				//optional
