...
class IFCPP_EXPORT IfcBuildingElementProxyTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcBuildingElementProxy : public IfcBuildingElement
{ 
public:
	IfcBuildingElementProxy();
	IfcBuildingElementProxy( int id );
	~IfcBuildingElementProxy();
	...
	virtual const char* className() const { return "IfcBuildingElementProxy"; }
	...
	// IfcBuildingElementProxy -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcBuildingElementProxyTypeEnum>					m_PredefinedType;			//optional
};
