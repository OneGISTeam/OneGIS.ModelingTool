...
class IFCPP_EXPORT IfcPlateTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcPlateType : public IfcBuildingElementType
{ 
public:
	IfcPlateType();
	IfcPlateType( int id );
	...
	virtual const char* className() const { return "IfcPlateType"; }
	...
	// IfcPlateType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcPlateTypeEnum>						m_PredefinedType;
};
