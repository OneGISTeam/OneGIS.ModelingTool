...
public:
	...
	virtual const char* className() const { return "IfcCostItem"; }
	...
	// IfcCostItem -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcCostItemTypeEnum>						m_PredefinedType;			//optional
	std::vector<shared_ptr<IfcCostValue> >				m_CostValues;				//optional
