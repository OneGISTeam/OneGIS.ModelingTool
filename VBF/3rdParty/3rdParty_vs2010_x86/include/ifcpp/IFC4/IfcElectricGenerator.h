...
class IFCPP_EXPORT IfcElectricGeneratorTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcElectricGenerator : public IfcEnergyConversionDevice
{ 
public:
	IfcElectricGenerator();
	IfcElectricGenerator( int id );
	~IfcElectricGenerator();
	...
	virtual const char* className() const { return "IfcElectricGenerator"; }
	...
	// IfcElectricGenerator -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcElectricGeneratorTypeEnum>					m_PredefinedType;			//optional
};
