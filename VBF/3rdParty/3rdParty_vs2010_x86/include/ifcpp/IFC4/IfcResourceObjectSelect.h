...
class IFCPP_EXPORT IfcResourceObjectSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcResourceObjectSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
