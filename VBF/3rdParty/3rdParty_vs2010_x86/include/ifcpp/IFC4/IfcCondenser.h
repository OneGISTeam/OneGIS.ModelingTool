...
//ENTITY
class IFCPP_EXPORT IfcCondenser : public IfcEnergyConversionDevice
{ 
public:
	IfcCondenser();
	IfcCondenser( int id );
	...
	virtual const char* className() const { return "IfcCondenser"; }
	...
	// IfcCondenser -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcCondenserTypeEnum>							m_PredefinedType;			//optional
};
