...
//ENTITY
class IFCPP_EXPORT IfcBuildingElementProxyType : public IfcBuildingElementType
{ 
public:
	...
	virtual const char* className() const { return "IfcBuildingElementProxyType"; }
	...
	// IfcBuildingElementProxyType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcBuildingElementProxyTypeEnum>			m_PredefinedType;
};
