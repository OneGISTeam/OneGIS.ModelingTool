...
//ENTITY
class IFCPP_EXPORT IfcBuildingStorey : public IfcSpatialStructureElement
{ 
public:
	IfcBuildingStorey();
	...
	virtual const char* className() const { return "IfcBuildingStorey"; }
	...
	// IfcBuildingStorey -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcLengthMeasure>								m_Elevation;				//optional
};
