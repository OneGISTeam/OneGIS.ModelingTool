...
//ENTITY
class IFCPP_EXPORT IfcConstructionEquipmentResourceType : public IfcConstructionResourceType
{ 
public:
	...
	virtual const char* className() const { return "IfcConstructionEquipmentResourceType"; }
