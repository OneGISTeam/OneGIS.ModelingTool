...
class IFCPP_EXPORT IfcTransformerTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcTransformerType : public IfcEnergyConversionDeviceType
{ 
public:
	IfcTransformerType();
	IfcTransformerType( int id );
	~IfcTransformerType();
	...
	virtual const char* className() const { return "IfcTransformerType"; }
	...
	// IfcTransformerType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcTransformerTypeEnum>					m_PredefinedType;
};
