...
class IFCPP_EXPORT IfcElectricApplianceTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcElectricAppliance : public IfcFlowTerminal
{ 
public:
	IfcElectricAppliance();
	IfcElectricAppliance( int id );
	~IfcElectricAppliance();
	...
	virtual const char* className() const { return "IfcElectricAppliance"; }
	...
	// IfcElectricAppliance -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcElectricApplianceTypeEnum>					m_PredefinedType;			//optional
};
