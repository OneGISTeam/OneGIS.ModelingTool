...
class IFCPP_EXPORT IfcValveTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcValveType : public IfcFlowControllerType
{ 
public:
	IfcValveType();
	IfcValveType( int id );
	...
	virtual const char* className() const { return "IfcValveType"; }
	...
	// IfcValveType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcValveTypeEnum>						m_PredefinedType;
};
