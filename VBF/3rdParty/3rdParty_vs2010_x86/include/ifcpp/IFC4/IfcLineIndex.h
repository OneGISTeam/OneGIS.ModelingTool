...
class IFCPP_EXPORT IfcLineIndex : public IfcPositiveInteger, public IfcSegmentIndexSelect
{
public:
	IfcLineIndex();
	~IfcLineIndex();
	...
	static shared_ptr<IfcLineIndex> createObjectFromSTEP( const std::wstring& arg );
