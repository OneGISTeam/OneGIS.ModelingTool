...
//ENTITY
class IFCPP_EXPORT IfcGeometricRepresentationItem : public IfcRepresentationItem
{ 
public:
	...
	virtual const char* className() const { return "IfcGeometricRepresentationItem"; }
