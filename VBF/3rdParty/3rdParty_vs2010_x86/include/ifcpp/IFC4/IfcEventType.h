...
public:
	...
	virtual const char* className() const { return "IfcEventType"; }
	...
	// IfcEventType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcEventTypeEnum>						m_PredefinedType;
	shared_ptr<IfcEventTriggerTypeEnum>					m_EventTriggerType;
