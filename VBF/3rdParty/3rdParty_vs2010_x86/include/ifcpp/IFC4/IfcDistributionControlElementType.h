...
//ENTITY
class IFCPP_EXPORT IfcDistributionControlElementType : public IfcDistributionElementType
{ 
public:
	...
	virtual const char* className() const { return "IfcDistributionControlElementType"; }
