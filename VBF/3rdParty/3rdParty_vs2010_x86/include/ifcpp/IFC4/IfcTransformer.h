...
//ENTITY
class IFCPP_EXPORT IfcTransformer : public IfcEnergyConversionDevice
{ 
public:
	IfcTransformer();
	...
	virtual const char* className() const { return "IfcTransformer"; }
	...
	// IfcTransformer -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcTransformerTypeEnum>							m_PredefinedType;			//optional
};
