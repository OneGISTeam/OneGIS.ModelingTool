...
class IFCPP_EXPORT IfcMetricValueSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcMetricValueSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
