...
class IFCPP_EXPORT IfcEngineTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcEngineType : public IfcEnergyConversionDeviceType
{ 
public:
	IfcEngineType();
	...
	virtual const char* className() const { return "IfcEngineType"; }
	...
	// IfcEngineType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcEngineTypeEnum>						m_PredefinedType;
};
