...
//ENTITY
class IFCPP_EXPORT IfcGeographicElementType : public IfcElementType
{ 
public:
	...
	virtual const char* className() const { return "IfcGeographicElementType"; }
	...
	// IfcGeographicElementType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcGeographicElementTypeEnum>			m_PredefinedType;
};
