...
class IFCPP_EXPORT IfcWarpingStiffnessSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcWarpingStiffnessSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
