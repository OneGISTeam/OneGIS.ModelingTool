...
class IFCPP_EXPORT IfcCableFittingTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcCableFitting : public IfcFlowFitting
{ 
public:
	IfcCableFitting();
	IfcCableFitting( int id );
	~IfcCableFitting();
	...
	virtual const char* className() const { return "IfcCableFitting"; }
	...
	// IfcCableFitting -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcCableFittingTypeEnum>							m_PredefinedType;			//optional
};
