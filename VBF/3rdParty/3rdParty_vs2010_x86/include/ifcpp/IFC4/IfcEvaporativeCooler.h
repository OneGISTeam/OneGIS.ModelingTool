...
class IFCPP_EXPORT IfcEvaporativeCoolerTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcEvaporativeCooler : public IfcEnergyConversionDevice
{ 
public:
	IfcEvaporativeCooler();
	IfcEvaporativeCooler( int id );
	~IfcEvaporativeCooler();
	...
	virtual const char* className() const { return "IfcEvaporativeCooler"; }
	...
	// IfcEvaporativeCooler -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcEvaporativeCoolerTypeEnum>					m_PredefinedType;			//optional
};
