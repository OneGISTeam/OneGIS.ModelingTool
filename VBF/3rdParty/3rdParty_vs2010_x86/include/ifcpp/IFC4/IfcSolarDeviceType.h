...
//ENTITY
class IFCPP_EXPORT IfcSolarDeviceType : public IfcEnergyConversionDeviceType
{ 
public:
	IfcSolarDeviceType();
	...
	virtual const char* className() const { return "IfcSolarDeviceType"; }
	...
	// IfcSolarDeviceType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcSolarDeviceTypeEnum>					m_PredefinedType;
};
