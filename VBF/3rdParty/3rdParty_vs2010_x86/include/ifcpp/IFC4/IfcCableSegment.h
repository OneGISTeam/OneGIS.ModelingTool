...
class IFCPP_EXPORT IfcCableSegmentTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcCableSegment : public IfcFlowSegment
{ 
public:
	IfcCableSegment();
	...
	virtual const char* className() const { return "IfcCableSegment"; }
	...
	// IfcCableSegment -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcCableSegmentTypeEnum>							m_PredefinedType;			//optional
};
