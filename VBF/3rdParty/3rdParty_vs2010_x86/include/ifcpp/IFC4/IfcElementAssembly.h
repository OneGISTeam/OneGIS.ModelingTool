...
//ENTITY
class IFCPP_EXPORT IfcElementAssembly : public IfcElement
{ 
public:
	IfcElementAssembly();
	...
	virtual const char* className() const { return "IfcElementAssembly"; }
	...
	// IfcElementAssembly -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcAssemblyPlaceEnum>							m_AssemblyPlace;			//optional
