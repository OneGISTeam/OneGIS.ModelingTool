...
class IFCPP_EXPORT IfcAirTerminalTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcAirTerminalType : public IfcFlowTerminalType
{ 
public:
	IfcAirTerminalType();
	...
	virtual const char* className() const { return "IfcAirTerminalType"; }
