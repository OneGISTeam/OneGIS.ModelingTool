...
public:
	...
	static shared_ptr<IfcStructuralActivityAssignmentSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
