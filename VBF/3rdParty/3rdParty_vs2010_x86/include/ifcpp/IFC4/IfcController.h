...
//ENTITY
class IFCPP_EXPORT IfcController : public IfcDistributionControlElement
{ 
public:
	IfcController();
	...
	virtual const char* className() const { return "IfcController"; }
	...
	// IfcController -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcControllerTypeEnum>							m_PredefinedType;			//optional
};
