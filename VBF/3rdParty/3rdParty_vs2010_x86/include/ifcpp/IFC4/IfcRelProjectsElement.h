...
class IFCPP_EXPORT IfcFeatureElementAddition;
//ENTITY
class IFCPP_EXPORT IfcRelProjectsElement : public IfcRelDecomposes
{ 
public:
	...
	virtual const char* className() const { return "IfcRelProjectsElement"; }
