...
public:
	...
	virtual const char* className() const { return "IfcCovering"; }
	...
	// IfcCovering -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcCoveringTypeEnum>								m_PredefinedType;			//optional
	// inverse attributes:
	std::vector<weak_ptr<IfcRelCoversSpaces> >					m_CoversSpaces_inverse;
	std::vector<weak_ptr<IfcRelCoversBldgElements> >			m_CoversElements_inverse;
};
