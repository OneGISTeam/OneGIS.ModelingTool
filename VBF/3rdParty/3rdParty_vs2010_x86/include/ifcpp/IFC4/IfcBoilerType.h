...
//ENTITY
class IFCPP_EXPORT IfcBoilerType : public IfcEnergyConversionDeviceType
{ 
public:
	IfcBoilerType();
	...
	virtual const char* className() const { return "IfcBoilerType"; }
	...
	// IfcBoilerType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcBoilerTypeEnum>						m_PredefinedType;
};
