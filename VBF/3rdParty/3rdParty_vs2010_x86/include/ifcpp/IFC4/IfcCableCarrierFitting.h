...
//ENTITY
class IFCPP_EXPORT IfcCableCarrierFitting : public IfcFlowFitting
{ 
public:
	IfcCableCarrierFitting();
	IfcCableCarrierFitting( int id );
	~IfcCableCarrierFitting();
	...
	virtual const char* className() const { return "IfcCableCarrierFitting"; }
	...
	// IfcCableCarrierFitting -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcCableCarrierFittingTypeEnum>					m_PredefinedType;			//optional
};
