...
class IFCPP_EXPORT IfcComplexPropertyTemplate;
class IFCPP_EXPORT IfcPropertySetTemplate;
//ENTITY
class IFCPP_EXPORT IfcPropertyTemplate : public IfcPropertyTemplateDefinition
{ 
public:
	IfcPropertyTemplate();
