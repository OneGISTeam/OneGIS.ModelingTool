...
class IFCPP_EXPORT IfcSlabTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcSlab : public IfcBuildingElement
{ 
public:
	IfcSlab();
	IfcSlab( int id );
	...
	virtual const char* className() const { return "IfcSlab"; }
	...
	// IfcSlab -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcSlabTypeEnum>									m_PredefinedType;			//optional
};
