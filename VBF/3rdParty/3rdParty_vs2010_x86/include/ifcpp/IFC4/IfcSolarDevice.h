...
class IFCPP_EXPORT IfcSolarDeviceTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcSolarDevice : public IfcEnergyConversionDevice
{ 
public:
	IfcSolarDevice();
	IfcSolarDevice( int id );
	~IfcSolarDevice();
	...
	virtual const char* className() const { return "IfcSolarDevice"; }
	...
	// IfcSolarDevice -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcSolarDeviceTypeEnum>							m_PredefinedType;			//optional
};
