...
//ENTITY
class IFCPP_EXPORT IfcElectricDistributionBoard : public IfcFlowController
{ 
public:
	...
	virtual const char* className() const { return "IfcElectricDistributionBoard"; }
	...
	// IfcElectricDistributionBoard -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcElectricDistributionBoardTypeEnum>			m_PredefinedType;			//optional
};
