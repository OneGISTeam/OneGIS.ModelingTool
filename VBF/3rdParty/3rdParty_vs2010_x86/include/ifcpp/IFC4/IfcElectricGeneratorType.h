...
//ENTITY
class IFCPP_EXPORT IfcElectricGeneratorType : public IfcEnergyConversionDeviceType
{ 
public:
	...
	virtual const char* className() const { return "IfcElectricGeneratorType"; }
	...
	// IfcElectricGeneratorType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcElectricGeneratorTypeEnum>			m_PredefinedType;
};
