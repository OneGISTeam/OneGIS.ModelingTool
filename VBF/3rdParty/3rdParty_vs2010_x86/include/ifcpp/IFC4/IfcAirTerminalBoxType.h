...
class IFCPP_EXPORT IfcAirTerminalBoxTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcAirTerminalBoxType : public IfcFlowControllerType
{ 
public:
	...
	virtual const char* className() const { return "IfcAirTerminalBoxType"; }
