...
//ENTITY
class IFCPP_EXPORT IfcPileType : public IfcBuildingElementType
{ 
public:
	IfcPileType();
	IfcPileType( int id );
	...
	virtual const char* className() const { return "IfcPileType"; }
	...
	// IfcPileType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcPileTypeEnum>							m_PredefinedType;
};
