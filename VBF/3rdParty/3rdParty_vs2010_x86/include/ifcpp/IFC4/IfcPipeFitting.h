...
//ENTITY
class IFCPP_EXPORT IfcPipeFitting : public IfcFlowFitting
{ 
public:
	IfcPipeFitting();
	...
	virtual const char* className() const { return "IfcPipeFitting"; }
	...
	// IfcPipeFitting -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcPipeFittingTypeEnum>							m_PredefinedType;			//optional
};
