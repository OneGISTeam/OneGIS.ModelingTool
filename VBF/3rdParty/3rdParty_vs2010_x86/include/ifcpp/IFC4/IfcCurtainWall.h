...
class IFCPP_EXPORT IfcCurtainWallTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcCurtainWall : public IfcBuildingElement
{ 
public:
	IfcCurtainWall();
	IfcCurtainWall( int id );
	~IfcCurtainWall();
	...
	virtual const char* className() const { return "IfcCurtainWall"; }
	...
	// IfcCurtainWall -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcCurtainWallTypeEnum>							m_PredefinedType;			//optional
};
