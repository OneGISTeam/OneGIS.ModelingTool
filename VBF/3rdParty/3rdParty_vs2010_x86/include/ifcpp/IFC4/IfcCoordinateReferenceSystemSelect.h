...
class IFCPP_EXPORT IfcCoordinateReferenceSystemSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcCoordinateReferenceSystemSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
