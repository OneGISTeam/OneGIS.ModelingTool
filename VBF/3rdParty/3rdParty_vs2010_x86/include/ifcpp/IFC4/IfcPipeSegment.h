...
class IFCPP_EXPORT IfcPipeSegmentTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcPipeSegment : public IfcFlowSegment
{ 
public:
	IfcPipeSegment();
	IfcPipeSegment( int id );
	~IfcPipeSegment();
	...
	virtual const char* className() const { return "IfcPipeSegment"; }
	...
	// IfcPipeSegment -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcPipeSegmentTypeEnum>							m_PredefinedType;			//optional
};
