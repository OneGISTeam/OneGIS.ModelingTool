...
class IFCPP_EXPORT IfcPileTypeEnum;
class IFCPP_EXPORT IfcPileConstructionEnum;
//ENTITY
class IFCPP_EXPORT IfcPile : public IfcBuildingElement
{ 
public:
	IfcPile();
	IfcPile( int id );
	...
	virtual const char* className() const { return "IfcPile"; }
	...
	// IfcPile -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcPileTypeEnum>									m_PredefinedType;			//optional
