...
//ENTITY
class IFCPP_EXPORT IfcRelAssociatesClassification : public IfcRelAssociates
{ 
public:
	...
	virtual const char* className() const { return "IfcRelAssociatesClassification"; }
	...
	// IfcRelAssociatesClassification -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcClassificationSelect>				m_RelatingClassification;
};
