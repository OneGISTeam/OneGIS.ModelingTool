...
class IFCPP_EXPORT IfcLibrarySelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcLibrarySelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
