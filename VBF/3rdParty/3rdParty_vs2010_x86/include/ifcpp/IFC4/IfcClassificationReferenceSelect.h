...
class IFCPP_EXPORT IfcClassificationReferenceSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcClassificationReferenceSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
