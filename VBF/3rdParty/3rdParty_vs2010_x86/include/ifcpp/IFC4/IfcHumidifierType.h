...
class IFCPP_EXPORT IfcHumidifierTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcHumidifierType : public IfcEnergyConversionDeviceType
{ 
public:
	IfcHumidifierType();
	...
	virtual const char* className() const { return "IfcHumidifierType"; }
	...
	// IfcHumidifierType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcHumidifierTypeEnum>					m_PredefinedType;
};
