...
//ENTITY
class IFCPP_EXPORT IfcFlowMeterType : public IfcFlowControllerType
{ 
public:
	IfcFlowMeterType();
	IfcFlowMeterType( int id );
	~IfcFlowMeterType();
	...
	virtual const char* className() const { return "IfcFlowMeterType"; }
	...
	// IfcFlowMeterType -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcFlowMeterTypeEnum>					m_PredefinedType;
};
