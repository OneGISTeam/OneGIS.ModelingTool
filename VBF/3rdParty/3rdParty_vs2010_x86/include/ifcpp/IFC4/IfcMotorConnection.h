...
//ENTITY
class IFCPP_EXPORT IfcMotorConnection : public IfcEnergyConversionDevice
{ 
public:
	IfcMotorConnection();
	...
	virtual const char* className() const { return "IfcMotorConnection"; }
	...
	// IfcMotorConnection -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcMotorConnectionTypeEnum>						m_PredefinedType;			//optional
};
