...
//ENTITY
class IFCPP_EXPORT IfcPresentationStyle : virtual public IfcStyleAssignmentSelect, public IfcPPEntity
{ 
public:
	...
	virtual const char* className() const { return "IfcPresentationStyle"; }
