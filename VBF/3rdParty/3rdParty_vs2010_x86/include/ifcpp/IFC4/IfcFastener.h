...
class IFCPP_EXPORT IfcFastenerTypeEnum;
//ENTITY
class IFCPP_EXPORT IfcFastener : public IfcElementComponent
{ 
public:
	IfcFastener();
	IfcFastener( int id );
	...
	virtual const char* className() const { return "IfcFastener"; }
	...
	// IfcFastener -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcFastenerTypeEnum>								m_PredefinedType;			//optional
};
