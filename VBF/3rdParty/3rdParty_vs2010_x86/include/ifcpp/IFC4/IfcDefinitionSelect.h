...
class IFCPP_EXPORT IfcDefinitionSelect : virtual public IfcPPObject
{
public:
	...
	static shared_ptr<IfcDefinitionSelect> createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map );
};
