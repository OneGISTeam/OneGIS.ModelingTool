...
//ENTITY
class IFCPP_EXPORT IfcDistributionElementType : public IfcElementType
{ 
public:
	IfcDistributionElementType();
	IfcDistributionElementType( int id );
	~IfcDistributionElementType();
	...
	virtual const char* className() const { return "IfcDistributionElementType"; }
