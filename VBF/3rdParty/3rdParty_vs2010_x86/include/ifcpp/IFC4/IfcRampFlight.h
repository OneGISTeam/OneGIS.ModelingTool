...
//ENTITY
class IFCPP_EXPORT IfcRampFlight : public IfcBuildingElement
{ 
public:
	IfcRampFlight();
	IfcRampFlight( int id );
	~IfcRampFlight();
	...
	virtual const char* className() const { return "IfcRampFlight"; }
	...
	// IfcRampFlight -----------------------------------------------------------
	// attributes:
	shared_ptr<IfcRampFlightTypeEnum>							m_PredefinedType;			//optional
};
