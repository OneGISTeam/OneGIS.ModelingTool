...
class OSG_EXPORT DrawPixels : public Drawable
{
    public:
        ...
        virtual CVBF_Object* cloneType() const { return new DrawPixels(); }

        virtual CVBF_Object* clone(const CopyOp& copyop) const { return new DrawPixels(*this,copyop); }
        
        virtual bool isSameKindAs(const CVBF_Object* obj) const { return dynamic_cast<const DrawPixels*>(obj)!=NULL; }
