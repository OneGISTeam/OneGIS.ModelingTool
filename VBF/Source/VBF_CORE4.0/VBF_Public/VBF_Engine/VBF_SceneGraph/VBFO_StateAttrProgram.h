...
/** osg::Program is an application-level abstraction of an OpenGL glProgram.
  ...
  * configuration.
  */
// 编程器，控制粒子在生命周期内的运动。一个编程器包括多个操作器
class OSG_EXPORT Program : public osg::StateAttribute
{
    public:
        ...
        class OSG_EXPORT ProgramBinary : public osg::CVBF_Object
        {
            public:
    ...
    public:
        ...
        class OSG_EXPORT PerContextProgram : public ::CVBF_Referenced
        {
            public:
            ...
            protected:        /*data*/
                ...
                ref_ptr<GL2Extensions> _extensions;
                ...
                typedef std::pair<ref_ptr<const osg::Uniform>, unsigned int> UniformModifiedCountPair;
    ...
    protected:        /*data*/
        ...
        mutable osg::buffered_value< ref_ptr<PerContextProgram> > _pcpList;
        ...
        ref_ptr<ProgramBinary> _programBinary;
