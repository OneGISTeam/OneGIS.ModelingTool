...
// IE¿ÉÄÜ´íÎó
        ...
        virtual osg::CVBF_Object* cloneType() const { return new Hint( _target, GL_DONT_CARE ); }
        virtual osg::CVBF_Object* clone(const osg::CopyOp& copyop) const { return new Hint(*this,copyop); }
        virtual bool isSameKindAs(const osg::CVBF_Object* obj) const { return dynamic_cast<const Hint *>(obj)!=NULL; }
