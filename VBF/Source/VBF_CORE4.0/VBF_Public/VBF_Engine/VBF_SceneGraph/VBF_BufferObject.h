...
class OSG_EXPORT GLBufferObject : public ::CVBF_Referenced
{
    public:
...
class OSG_EXPORT GLBufferObjectSet : public ::CVBF_Referenced
{
    public:
...
class OSG_EXPORT GLBufferObjectManager : public ::CVBF_Referenced
{
    public:
        ...
        static ref_ptr<GLBufferObjectManager>& getGLBufferObjectManager(unsigned int contextID);

    protected:

        typedef std::map< BufferObjectProfile, ref_ptr<GLBufferObjectSet> > GLBufferObjectSetMap;
        unsigned int            _contextID;
...
class OSG_EXPORT BufferObject : public CVBF_Object
{
    public:
        ...
        virtual bool isSameKindAs(const CVBF_Object* obj) const { return dynamic_cast<const BufferObject*>(obj)!=NULL; }
    ...
    protected:
        ...
        typedef osg::buffered_object< ref_ptr<GLBufferObject> > GLBufferObjects;
...
class OSG_EXPORT BufferData : public CVBF_Object
{
    public:
        ...
        virtual bool isSameKindAs(const CVBF_Object* obj) const { return dynamic_cast<const BufferData*>(obj)!=NULL; }
        virtual const char* libraryName() const { return "osg"; }
        ...
        struct ModifiedCallback : public virtual osg::CVBF_Object
        {
            ModifiedCallback() {}
...
protected:
        ...
        ref_ptr<ModifiedCallback>  _modifiedCallback;
};
