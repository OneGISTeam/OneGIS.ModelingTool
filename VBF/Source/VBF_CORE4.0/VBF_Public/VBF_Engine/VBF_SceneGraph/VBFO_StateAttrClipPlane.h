...
// IE¿ÉÄÜ´íÎó
        ...
        virtual osg::CVBF_Object* cloneType() const { return new ClipPlane( _clipPlaneNum ); }
        virtual osg::CVBF_Object* clone(const osg::CopyOp& copyop) const { return new ClipPlane(*this,copyop); }
        virtual bool isSameKindAs(const osg::CVBF_Object* obj) const { return dynamic_cast<const ClipPlane *>(obj)!=NULL; }
