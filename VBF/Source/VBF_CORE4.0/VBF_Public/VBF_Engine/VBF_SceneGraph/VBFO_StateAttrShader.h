...
class OSG_EXPORT ShaderAttribute : public StateAttribute
{
    public :
        ...
        virtual osg::CVBF_Object* clone(const osg::CopyOp& copyop) const { return new ShaderAttribute(*this,copyop); }
        virtual bool isSameKindAs(const osg::CVBF_Object* obj) const { return dynamic_cast<const ShaderAttribute *>(obj)!=NULL; }
