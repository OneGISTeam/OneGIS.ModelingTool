...
#include <VBF_Engine/VBF_Shadow/DebugShadowMap>
...
class OSGSHADOW_EXPORT StandardShadowMap : public DebugShadowMap
{
    ...
    protected:
        ...
        ref_ptr< osg::Shader >   _mainVertexShader;
        ref_ptr< osg::Shader >   _mainFragmentShader;
        ref_ptr< osg::Shader >   _shadowVertexShader;
        ref_ptr< osg::Shader >   _shadowFragmentShader;
