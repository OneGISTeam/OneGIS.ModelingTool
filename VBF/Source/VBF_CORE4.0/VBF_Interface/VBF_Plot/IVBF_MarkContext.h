//*******************************************************************
// FileName：IVBF_MarkContext.h
// Function：标图所需要的上下文环境
// Author:
// Date:     2016-12-16
//*******************************************************************

#ifndef __IVBF_MARK_CONTEXT_H__
#define __IVBF_MARK_CONTEXT_H__
...
class IVBF_MarkContext : public CVBF_Referenced
{
public:
    virtual ~IVBF_MarkContext() {}
    ...
    //virtual double GetRadiusEquator();
