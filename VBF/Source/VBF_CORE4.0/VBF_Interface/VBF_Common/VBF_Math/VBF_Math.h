#ifndef __VBF_MATH_H__
#define __VBF_MATH_H__
...
VBF_MATH_EXPORT double asciiToDouble(const char* str);
...
VBF_MATH_EXPORT double findAsciiToDouble(const char* str);
