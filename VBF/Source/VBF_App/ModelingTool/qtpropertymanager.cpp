...
public:
    ...
    QMap<const QtProperty *, QString> m_values;
};

/*!
    \class QtPathPropertyManager

    \brief The QtPathPropertyManager provides and manages QString properties.
    ...
    In addition, QtPathPropertyManager provides the valueChanged() signal
    which is emitted whenever a property created by this manager
    changes, and the regExpChanged() signal which is emitted whenever
    such a property changes its currently set regular expression.
...
/*!
    \fn void QtPathPropertyManager::valueChanged(QtProperty *property, const QString &value)
...
/*!
    \fn void QtPathPropertyManager::regExpChanged(QtProperty *property, const QRegExp &regExp)
...
QtPathPropertyManager::QtPathPropertyManager(QObject *parent)
    : QtAbstractPropertyManager(parent)
{
    d_ptr = new QtPathPropertyManagerPrivate;
    d_ptr->q_ptr = this;
}
...
{
    const QtPathPropertyManagerPrivate::PropertyValueMap::const_iterator it = d_ptr->m_values.constFind(property);
    if (it == d_ptr->m_values.constEnd())
        return QString();
...
/*!
    \fn void QtPathPropertyManager::setValue(QtProperty *property, const QString &value)
